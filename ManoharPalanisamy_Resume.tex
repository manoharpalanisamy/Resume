...
\begin{center}
    ...
    \href{https://linkedin.com/in/manoharpalanisamy}{\raisebox{-0.2\height}\faLinkedin\ \textcolor{MidnightBlue}{\underline{manoharpalanisamy}}}  ~
...
\section{WORK EXPERIENCES}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
\resumeItem{
  Deployed document Q\&A RAG pipelines in Generative AI, leveraging LLMs and vector embeddings to enhance natural language processing capabilities. Utilized AWS services and efficient deployment tools for effective implementation.
}
\resumeItem{
  Collaborated across teams to deploy scalable AI systems, integrating cloud computing, version control systems, and CI/CD pipelines for iterative development and deployment of advanced machine learning solutions.
}
\resumeItem{
  Optimized operational efficiency by integrating AI models into production systems using containerization, automation frameworks, and modern AI deployment practices, ensuring robust deployment of Document Q\&A RAG pipelines and other AI applications.
}
\resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{
      Developed FieldSense, a research-based web application for Salesforce tracking. handled feature enhancements and bug fixes, including requirements analysis, design documentation, and impact analysis.
      }
      \resumeItem{
      Worked on an email system, ensuring timely delivery and quality, adhering to network and email protocols and client standards.
      }
    \resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \item{
        ...
        \textbf{Gen AI Frameworks:} OpenAI GPT-3.5, Meta Llama3, Langchain Ecosystem, HuggingFace Transformers, Google Generative AI, crewAI \\
        \vspace{0.15cm}
        \textbf{Inference Engine:} AWS Bedrock, CROQ \\
        \vspace{0.15cm}
...
\section{CERTIFICATIONS}
    \resumeSubHeadingListStart
        \resumeSubheading
            {Generative AI with Large Language Models \textcolor{MidnightBlue}{\fontsize{9}{11}\selectfont{\href{https://coursera.org/verify/MAVEJZ9P9AV5}{[MAVEJZ9P9AV5]}}}}{Sep 2023 -- Apr 2024}{DeepLearning.AI And Amazon Web Services}{Coursera.org}
    \resumeSubheading
            {Deep Learning Specialization \textcolor{MidnightBlue}{\fontsize{9}{11}\selectfont{\href{https://coursera.org/verify/specialization/EKJCGU5G2NXF}{[EKJCGU5G2NXF]}}}}{July 2023 -- Feb 2024}{DeepLearning.AI}{Coursera.org}
    \resumeSubheading
            {Machine Learning Specialization \textcolor{MidnightBlue}{\href{https://coursera.org/verify/specialization/2CE3DQW8Z2NG}{{\fontsize{9}{11}\selectfont[2CE3DQW8Z2NG]}}}}{Jun 2023 -- Feb 2024}{Stanford University And DeepLearning.AI}{Coursera.org}
    \resumeSubheading
            {Applied AI with DeepLearning \textcolor{MidnightBlue}{\fontsize{9}{11}\selectfont{\href{https://coursera.org/verify/DRENBUK43NW8}{[DRENBUK43NW8]}}}}{Dec 2021 -- Jan 2022}{IBM}{Coursera.org}
    \resumeSubHeadingListEnd
...
\section{PROJECTS}
  ...
  {\textbf{\href{https://github.com/manoharpalanisamy/crewAI}{\textcolor{MidnightBlue}{crewAI Agents: Automating AI Content Generation}}} $|$ \emph{crewAI, Langchain, DuckDuckGo}}{}
  \resumeItemListStart
      \resumeItem{Developed an automated workflow for AI research and content generation using crewAI and langchain tools.}
      \resumeItem{Implemented a multi-agent system where a Senior Research Analyst gathers information using DuckDuckGo search tool and a Tech Content Strategist crafts compelling blog content based on the research.}
  \resumeItemListEnd
  \vspace{-13pt}


    \resumeProjectHeading
    {\textbf{\href{https://github.com/manoharpalanisamy/Build-and-deploy-RAG-in-AWS-lambda-ECR-docker-langchain-Huggingface-}{\textcolor{MidnightBlue}{RAG-Powered Document Q\&A with LLMOps}}} $|$ \emph{AWS Bedrock, AppRunner, ECR, Langchain, FAISS, Docker, GitHub Actions, LangSmith, Streamlit}}{}
    \resumeItemListStart
        \resumeItem{Implemented a RAG model for document-based Q\&A using AWS Bedrock meta.llama2-13b-chat-v1 for inference and amazon.titan-embed-text-v1 for embeddings, leveraging LLMOps principles.}
        \resumeItem{Utilized AWS services like Bedrock, AppRunner, and ECR for scalable deployment and Langchain for NLP tasks.}
        \resumeItem{Employed FAISS for efficient similarity search and clustering, Docker for containerization, and GitHub Actions for CI/CD, adhering to LLMOps best practices.}
    \resumeItemListEnd
    \vspace{-13pt}
    ...
    \resumeSubHeadingListStart
        \resumeSubheading{Fake Account Eliminator}{March 2015}{National Conference on Engineering Applications for Developing Smart Cities - NCEADS}{}
            \resumeItemListStart
                ...
                \resumeItem{It uses the UIDAI (Unique Identification Authority of India) as a key part of its operation. India has many fake users on social media and email, so this tool helps to identify and eliminate them. It enforces a rule where each person can only have one account, reducing problems for real users and the public}
            \resumeItemListEnd
    \resumeSubHeadingListEnd
...
%-----------Last update-----------
\vspace{50pt} % Adjust vertical space as needed
\begin{center}
    Last update: \today
\end{center}
